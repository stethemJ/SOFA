...
VSH linear combinations (10+ terms each) as EField ground-reflected 3D
surfaces (image theory), radius = ||E|| = sqrt(E_theta^2 + E_phi^2),
colored by magnitude with plasma.
"""
import numpy as np
