...
from forward_model.tools.Convolution import beam_power_coefficients, sky_coefficients, antenna_temperature
...
ax.set_title(f"log_poly_exp fit residuals (N={FIT_N}) vs beam complexity, spectral-index sky, h={HEIGHT} m")
ax.legend()
ax.grid(True)
