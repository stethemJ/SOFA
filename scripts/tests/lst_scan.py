...
vmin, vmax = above_values.min(), above_values.max()
...
analyze = Analyze(basis, HEIGHT, observers[0], sky_model="2008", l_max=L_MAX, nside=NSIDE)
...
T_stack_mid = [Analyze(basis, HEIGHT, obs, sky_model="2008", l_max=L_MAX, nside=NSIDE)
